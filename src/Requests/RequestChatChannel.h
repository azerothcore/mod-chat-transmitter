#ifndef _MOD_CHAT_TRANSMITTER_REQUESTS_CHAT_CHANNEL_H_
#define _MOD_CHAT_TRANSMITTER_REQUESTS_CHAT_CHANNEL_H_
...
#endif // _MOD_CHAT_TRANSMITTER_REQUESTS_CHAT_CHANNEL_H_
